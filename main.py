...
def backup_all(lst_source_dir, destination_dir, start_backup_date_actual):  
...
# print(get_incremental_directories(r'F:\_BACKUP ALL PHOTOS\BAO PHOTOS\Apps', date(2022,1,1)))